      ...
      <table class="market table me-4">
        <thead class="js-sort-advanced">
          <tr>
            ...
            <th width="14%">上價
              <span>
                <i class="bi bi-caret-up-fill" @click="sortData('上價', 'up')"
                  v-if="activeSortField === '上價' && activeSortDirection === 'up'"></i>
                <i class="bi bi-caret-up" @click="sortData('上價', 'up')" v-else></i>

                <i class="bi bi-caret-down-fill" @click="sortData('上價', 'down')"
                  v-if="activeSortField === '上價' && activeSortDirection === 'down'"></i>
                <i class="bi bi-caret-down" @click="sortData('上價', 'down')" v-else></i>
              </span>
            </th>
            <th width="14%">中價
              <span>
                <i class="bi bi-caret-up-fill" @click="sortData('中價', 'up')"
                  v-if="activeSortField === '中價' && activeSortDirection === 'up'"></i>
                <i class="bi bi-caret-up" @click="sortData('中價', 'up')" v-else></i>

                <i class="bi bi-caret-down-fill" @click="sortData('中價', 'down')"
                  v-if="activeSortField === '中價' && activeSortDirection === 'down'"></i>
                <i class="bi bi-caret-down" @click="sortData('中價', 'down')" v-else></i>
              </span>
            </th>
            <th width="14%">下價
              <span>
                <i class="bi bi-caret-up-fill" @click="sortData('下價', 'up')"
                  v-if="activeSortField === '下價' && activeSortDirection === 'up'"></i>
                <i class="bi bi-caret-up" @click="sortData('下價', 'up')" v-else></i>

                <i class="bi bi-caret-down-fill" @click="sortData('下價', 'down')"
                  v-if="activeSortField === '下價' && activeSortDirection === 'down'"></i>
                <i class="bi bi-caret-down" @click="sortData('下價', 'down')" v-else></i>
              </span>
            </th>
            <th width="14%">平均價
              <span>
                <i class="bi bi-caret-up-fill" @click="sortData('平均價', 'up')"
                  v-if="activeSortField === '平均價' && activeSortDirection === 'up'"></i>
                <i class="bi bi-caret-up" @click="sortData('平均價', 'up')" v-else></i>

                <i class="bi bi-caret-down-fill" @click="sortData('平均價', 'down')"
                  v-if="activeSortField === '平均價' && activeSortDirection === 'down'"></i>
                <i class="bi bi-caret-down" @click="sortData('平均價', 'down')" v-else></i>
              </span>
            </th>
            <th width="14%">交易量
              <span>
                <i class="bi bi-caret-up-fill" @click="sortData('交易量', 'up')"
                  v-if="activeSortField === '交易量' && activeSortDirection === 'up'"></i>
                <i class="bi bi-caret-up" @click="sortData('交易量', 'up')" v-else></i>

                <i class="bi bi-caret-down-fill" @click="sortData('交易量', 'down')"
                  v-if="activeSortField === '交易量' && activeSortDirection === 'down'"></i>
                <i class="bi bi-caret-down" @click="sortData('交易量', 'down')" v-else></i>
              </span>
            </th>
          </tr>
        </thead>
...
const sortData = (price, sort) => { // 排序資料函式
  activeSortField.value = price // 記錄當前排序欄位
  activeSortDirection.value = sort // 記錄當前排序方向
...
const activeSortField = ref('') // 當前排序的欄位
const activeSortDirection = ref('') // 當前排序的方向 (up/down)
